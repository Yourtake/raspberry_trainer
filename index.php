<!DOCTYPE html>
<!-- saved from url=(0020)http://66.45.253.57/ -->
...
<body>
	<article class="main">
    	<header>
    	<h1>ganesh dalvi (cpf)</h1>
    </header> 
    	<section class="sec_profile">
    	<ul>
        	<li>
            	<div class="bxProfile bxMyProfile">
        	...
        	<li>
            	<div class="bxProfile bxFeedback">
                	<div class="imgProfile_desk">
        	...
        	<li>
            	<div class="bxProfile bxTraining">
                	<div class="imgProfile_desk">
        	...
        	<li>
            	<div class="bxProfile bxProgram">
                	<div class="imgProfile_desk">
                    	<img src="assets/images/program.jpg">
                    </div>
                	<div class="imgProfile_mobile">
        	...
        	<li>
            	<div class="bxProfile bxregistration">
                	<div class="imgProfile_desk">
