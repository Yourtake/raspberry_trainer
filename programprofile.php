...
<html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
            ...
            <link href="assets/css/images/logo.png" rel="shortcut icon">
                                   ...
                                   <link type="text/css" href="assets/css/bootstrap.min.css" rel="stylesheet">
                                    ...
                                    <link type="text/css" href="assets/css/programprofile.css" rel="stylesheet">
                                ...
                                <div class="row">
                                 <div class="col-xs-12">
                                     <a style="color:white" href="index.php"> <h3 style="text-align: left"><span >&#xab;</span>&nbsp;Back</h3></a>
                                                       ...
                                                       <div class="container" style="background-color: rgba(128, 128, 128,0.70);border-radius: 15px">
                                     <center>
                                         <h2>Today's Program Structure</h2>
                                         <h3><u>It's all in the details!!</u></h3>
                                     </center>
                          <br>
                                                           <p>9:30 am - 12.30 pm  1st Half</p>
                                                           <p>12:30 pm - 1:00 pm Lunch</p>
                                                           <p>1:00 pm - 6:30 - 2nd Half</p>
                                  </div>
